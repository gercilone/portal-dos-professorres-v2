                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-zinc-950/60 border-b border-zinc-850 text-zinc-500 text-[10px] font-bold tracking-wider uppercase">
                      ...
                      <th className="py-3 px-4 text-center w-24 bg-amber-500/5 border-x border-zinc-900 text-amber-400 font-extrabold">R1</th>
                      <th className="py-3 px-4 text-center w-24">3º Bim</th>
                      <th className="py-3 px-4 text-center w-24">4º Bim</th>
                      <th className="py-3 px-4 text-center w-24 bg-amber-500/5 border-x border-zinc-900 text-amber-400 font-extrabold">R2</th>
                      <th className="py-3 px-4 text-center w-24 bg-rose-500/5 border-l border-zinc-900 text-red-400 font-extrabold">PF</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-zinc-900 text-xs">
                    {subjects.map(subj => {
                      const extraRecord = reportData?.extraGrades.find(
                        eg => String(eg.studentId) === String(student.id) && 
